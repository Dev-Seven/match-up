                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.cms_page.edit_page')</h3>
                        </div>
                        <form action="{{route('admin.cms.update')}}" method="post" id="cms_page_create">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" value="{{$page->title}}" placeholder="@lang('messages.cms_page.enter_title')">
                                            @error('title')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$page->short_description}}" class="form-control" name="short_description" placeholder="@lang('messages.cms_page.short_description')">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" rows="5" placeholder="@lang('messages.cms_page.description')">{{$page->description}}</textarea>
                                            @error('description')
                                            <span class="error">{{$message}}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="status">
                                                ...
                                                <option @if($page->status == 1) selected="selected" @endif value="1">@lang('messages.cms_page.active')</option>
                                                <option @if($page->status == 0) selected="selected" @endif value="0">@lang('messages.cms_page.inactive')</option>
                                            </select>
                                            @error('status')
                                            <span class="error">{{$message}}</span>
                                            @endif
