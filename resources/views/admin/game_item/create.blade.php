                ...
                <div class="col-md-6">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.game_item.create_item')</h3>
                        </div>
                        <form action="{{route('admin.game_item.store')}}" method="post" id="game_item_create" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('name')}}" type="text" class="form-control" name="name" placeholder="@lang('messages.game_item.enter_name')">
                                            @error('name')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('name_de')}}" type="text" class="form-control" name="name_de" placeholder="@lang('messages.game_item.enter_name_de')">
                                            @error('name_de')
                                            <span class="error">{{$message}}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="status">
                                                ...
                                                <option @if(old('status') == '1') selected="selected" @endif value="1">@lang('messages.game_item.active')</option>
                                                <option @if(old('status') == '0') selected="selected" @endif value="0">@lang('messages.game_item.inactive')</option>
                                            </select>
                                            @error('status')
                                            <span class="error">{{$message}}</span>
                                            @endif
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="checkbox" value="1" name="item_selection" id="flexCheckDefault">
...
<script type="text/javascript">
    $("#game_item_create").validate({
        ...
        messages: {
            ...
            "image":{
                required:'{{__("messages.game_item.validation.image_required")}}',
            },
            "status":{
