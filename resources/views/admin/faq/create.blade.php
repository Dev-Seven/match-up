...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('messages.faq.create_faq')</h1>
                </div>
            </div>
        </div><!-- /.container-fluid --> 
    </section>
                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.faq.create_faq')</h3>
                        </div>
                        <form action="{{route('admin.faq.store')}}" method="post" id="faq_create">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('title')}}" type="text" class="form-control" name="title" placeholder="@lang('messages.faq.enter_title')">
                                            @error('title')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea  name="description" class="form-control" rows="5" placeholder="@lang('messages.faq.description')">{{old('description')}}</textarea>
                                            @error('description')
                                            <span class="error">{{$message}}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="status">
                                                ...
                                                <option @if(old('status') == '1') selected="selected" @endif value="1">@lang('messages.faq.active')</option>
                                                <option @if(old('status') == '0') selected="selected" @endif value="0">@lang('messages.faq.inactive')</option>
                                            </select>
                                            @error('status')
                                            <span class="error">{{$message}}</span>
                                            @endif
