...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('messages.tags.tag_create')</h1>
                </div>
            </div>
        </div><!-- /.container-fluid --> 
    </section>
                ...
                <div class="col-md-6">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.tags.tag_create')</h3>
                        </div>
                        <form action="{{route('admin.tags.store')}}" method="post" id="tag_create">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('name')}}" type="text" class="form-control" name="name" placeholder="@lang('messages.tags.enter_name')">
                                            @error('name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="status">
                                                ...
                                                <option @if(old('status') == '1') selected="selected" @endif value="1">@lang('messages.tags.active')</option>
                                                <option @if(old('status') == '0') selected="selected" @endif value="0">@lang('messages.tags.inactive')</option>
                                            </select>
                                            @error('status')
                                            <span class="error">{{$message}}</span>
                                            @endif
