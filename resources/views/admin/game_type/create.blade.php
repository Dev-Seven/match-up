                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.game_type.create_type')</h3>
                        </div>
                        <form action="{{route('admin.game_type.store')}}" method="post" id="game_type_create" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('title')}}" type="text" class="form-control" name="title" placeholder="@lang('messages.game_type.enter_title')">
                                            @error('title')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('number')}}" type="text" class="form-control" name="number" placeholder="@lang('messages.game_type.enter_number')">
                                            @error('number')
                                            <span class="error">{{$message}}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="status">
                                                ...
                                                <option @if(old('status') == '1') selected="selected" @endif value="1">@lang('messages.game_type.active')</option>
                                                <option @if(old('status') == '0') selected="selected" @endif value="0">@lang('messages.game_type.inactive')</option>
                                            </select>
                                            @error('status')
                                            <span class="error">{{$message}}</span>
                                            @endif
